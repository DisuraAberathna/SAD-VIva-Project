...
public class ManageUser extends javax.swing.JPanel {
    ...
    private void loadUsers() {
        ...
        if (jComboBox3.getSelectedIndex() != 0) {
            query += "AND `status` = '" + (jComboBox3.getSelectedIndex()) + "' ";
        }
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("User Address");
        ...
        jMenuItem2.setText("Update User Status");
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Active", "Deactive", "Banded" }));
        jComboBox3.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "User Status", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Comic Sans MS", 0, 14), new java.awt.Color(0, 0, 0))); // NOI18N
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        if (row != -1) {
            if (String.valueOf(jTable1.getValueAt(row, 8)).equals("Active")) {
                new UserAddress(this.dashboard, true, String.valueOf(jTable1.getValueAt(row, 0))).setVisible(true);
                clear();
                loadUsers();
            } else {
                JOptionPane.showMessageDialog(this, "Not a active user", "Warining", JOptionPane.WARNING_MESSAGE);
            ...
            JOptionPane.showMessageDialog(this.dashboard, "Please select a user", "Warning", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        int row = jTable1.getSelectedRow();
        if (row != -1) {
            new UserStatus(this.dashboard, true, String.valueOf(jTable1.getValueAt(row, 0)), String.valueOf(jTable1.getValueAt(row, 8))).setVisible(true);
            clear();
            loadUsers();
        } else {
            JOptionPane.showMessageDialog(this.dashboard, "Please select a user", "Warning", JOptionPane.WARNING_MESSAGE);
