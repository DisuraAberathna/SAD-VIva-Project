...
public class Product extends javax.swing.JDialog {
    ...
    public Product(java.awt.Frame parent, boolean modal, HashMap<String, String> map) {
        super(parent, modal);
        initComponents();
        this.dashboard = (Dashboard) parent;
        loadDetails(map);
    ...
    private boolean validation() {
        if (jTextField2.getText().isEmpty()) {
            ...
            return false;
        } else if (jTextField3.getText().isEmpty() && this.categoryId == null) {
            JOptionPane.showMessageDialog(this, "Please select category", "Warning", JOptionPane.WARNING_MESSAGE);
            jTextField3.requestFocus();
            return false;
        } else if (jTextField4.getText().isEmpty() && this.brandId == null) {
            JOptionPane.showMessageDialog(this, "Please select category", "Warning", JOptionPane.WARNING_MESSAGE);
    ...
    private void initComponents() {
        ...
        jTextField2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Title", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Comic Sans MS", 0, 14), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        jTextField3.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Category", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Comic Sans MS", 0, 14), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        jTextField4.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Brand", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Comic Sans MS", 0, 14), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        if (validation()) {
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    Database.execute("INSERT INTO `product` (`name`, `category_id`, `brand_id`, `status`) VALUES ('" + name + "', '" + this.categoryId + "', '" + this.brandId + "', '1')");
